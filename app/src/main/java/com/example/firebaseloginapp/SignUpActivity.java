...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUpEmail.setText(signUpIntent.getStringExtra(MainActivity.EXTRA_SIGNUP_EMAIL));
        signUpPassword = (EditText) findViewById(R.id.editTextSignUpPassword);
        signUpPassword.setText(signUpIntent.getStringExtra(MainActivity.EXTRA_SIGNUP_PASSWORD));
